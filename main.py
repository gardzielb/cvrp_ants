...
if __name__ == '__main__':
	problems = [
		...
		load_augerat_example('A-n33-k5.vrp'),
	...
	solvers = [
		...
		# AntColonyCVRPSolver(iterations = 100, permute_routes = True, show_progress = True),
		# AntColonyCVRPSolver(iterations = 100, candidate_fraction = 0.25, show_progress = True)
	]
